...
const contractABI = require("../artifacts/contracts/Learningtone.sol/Learningtone.json").abi;

program
    .name("learningtone-cli")
    .description("CLI tool for Learningtone smart contract")
    .version("1.0.0");
